# 10-language/data-manipulation/system-functions

Intrinsic/system functions usable in expressions (ABS, CNVRT$, POS, DATE$, ...).

**📄 Guide → [spec.md](spec.md)** _(status: 2b)_ — BR's intrinsic functions — they return a value and are used inside
