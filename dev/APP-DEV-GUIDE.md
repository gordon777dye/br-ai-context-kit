...
| **App design** — architecture, data model, modules | the generated **data-model** (§4) + conventions (§1) | br_tree concept leaves — [`file-model`](../br_tree/30-io-file/file-model/spec.md), [`library-facility`](../br_tree/50-libraries/library-facility/spec.md), [`screenio`](../br_tree/50-libraries/screenio/spec.md) |
...
| **Your app's** data model (files/fields/keys) | generate it — see §4 (`tools/extract-schema.js`) |
